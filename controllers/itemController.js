...
exports.menu = function(req, res, next) {
    async.parallel({
        ...
        lindemOudeKriek2019: function(callback) {Item.findOne({name: 'Lindemans Oude Kriek Cuvée René 2019'}).exec(callback)},
        ...
        mulekicker: function(callback) {Item.findOne({name: "New Level Craft Soda Mocktail Mulekicker"}).exec(callback)},
        ...
        garagePeach: function(callback) {Item.findOne({name: "Garage Kombucha: Peach"}).exec(callback)},
        garagePassion: function(callback) {Item.findOne({name: "Garage Kombucha: Passion Fruit"}).exec(callback)},
        garageRasp: function(callback) {Item.findOne({name: "Garage Kombucha: Raspberry"}).exec(callback)},
        garageMango: function(callback) {Item.findOne({name: "Garage Kombucha: Mango"}).exec(callback)},
        ...
        res.render('menu', {
            ...
            lindem: items.lindem,
            lindemOudeKriek2019: items.lindemOudeKriek2019,
            orval: items.orval,
            ...
            mulekicker: items.mulekicker,
            NLPain: items.NLPain,
            jamaic: items.jamaic,
            garagePeach: items.garagePeach,
            garagePassion: items.garagePassion,
            garageRasp: items.garageRasp,
            garageMango: items.garageMango,
