...
exports.index = function(req, res, next) {
    async.parallel({
        ...
        annex: function(callback) {Item.findOne({name: 'Annex Force Majeure NE IPA'}).exec(callback)},
        ...
        syc: function(callback) {Item.findOne({name: 'SYC Pontification Italian Pilsner'}).exec(callback)},
        ...
        lunch_feature: function(callback) {Item.findOne({name: 'Lunch Feature'}).exec(callback)},
        ...
        res.render('index', {
            ...
            yam: items.yam,
            soup: items.soup,
            lunch_feature: items.lunch_feature,
